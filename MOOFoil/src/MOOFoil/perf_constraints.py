...
class KeyPerformanceConstraint():
    def __init__(self, key, cases, lower_bound = -1e16, upper_bound = 1e16):
        self.key = key
        self.cases = cases
...
class ValuePerformanceConstraint():
    def __init__(self, cases, lower_bound = -1e16, upper_bound = 1e16):
        self.cases = cases
        self.lower_bound = lower_bound
        self.upper_bound = upper_bound
